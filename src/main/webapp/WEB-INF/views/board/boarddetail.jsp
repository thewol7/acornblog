...
<script>
	function backTolist() {
		location.href = "${pageContext.request.ContextPath}/board/boardlist.do?page_id=${id}";
	};
	// 로그인 안되어 있을때 글쓰기 클릭시 실행할 함수
	function mvUpdateForm() {
		location.href = "${pageContext.request.ContextPath}/board/boardupdateform.do?page_id=${id}&cont_id=${cont_id}";
	}
</script>
<body>
