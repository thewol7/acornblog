...
<script>
	function backTolist() {
		location.href = "${pageContext.request.contextPath}/picboard/picboardlist.do?";
	};
	function mvUpdateForm() {
		location.href = "${pageContext.request.contextPath}/picboard/picboardupdateform.do?cont_id=${cont_id}";
	}
	function deletePic() {
		location.href = "${pageContext.request.contextPath}/picboard/picboarddelete.do?cont_id=${cont_id}";
	}
</script>
<body>
	<!-- Wrapper -->
