...
public class PicDto {
	...
	public PicDto(int user_id, int cont_id, String name, String content_title, String content_content, String pic,
			int view_count, String cont_date, int startRowNum, int endRowNum, int prevNum, int nextNum) {
		super();
